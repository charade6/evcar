      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td colSpan="2">
              <dl>
                ...
                <dd>
                  - 충전기 위치가 외부에 설치되어 눈, 비에 노출될 경우만 케노피
                  설치
                </dd>
              </dl>
            </td>
          ...
          <tr>
            <td>사진</td>
            <td>
              <img alt="벽부형 충전기 이미지" src={info3Img1} width="100px" />
            </td>
            <td>
              <img alt="벽부형 충전기 이미지" src={info3Img2} width="150px" />
            </td>
            <td>
              <img alt="벽부형 충전기 이미지" src={info3Img3} width="120px" />
              <img alt="벽부형 충전기 이미지" src={info3Img4} width="120px" />
            </td>
          </tr>
        </tbody>
      </table>
