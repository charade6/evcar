...
import infoImg1 from "../assets/infoimg/infoimg1.jpg"
import infoImg2 from "../assets/infoimg/infoimg2.jpg"
import infoImg3 from "../assets/infoimg/infoimg3.jpg"
import infoImg4 from "../assets/infoimg/infoimg4.jpg"
      ...
      <div className="main-content infoBox">
        ...
        <div className="info-cont">
          ...
          <p>
            ...
            발생시키는 차량으로, 화석연료를 전혀 사용하지 않는 무공해
            차량입니다.
          </p>
          <div className="cont1">
            <img className="img1" src={infoImg1} alt="img" />
          ...
          <div className="cont2">
            <img className="img2" src={infoImg2} alt="img" />
            <div className="right">
              <dl className="right-cont1">
                <dt>외부 전력 공급을 통한 충전 필요</dt>
                <dt>
                  급속충전기는 50kW급으로 완전방전상태에서 80%충전까지 30분이
                  소요되며, 완속충전기는 약 6~7kW급으로 완전방전에서 완전충전
                  까지4~5시간이 소요됨
                </dt>
              </dl>
              <dl className="right-cont2">
                <dt>
                  내연기관 엔진없이 충전된 배터리에서 공급되는 전기에너지만을
                  동력원으로 전기모터를 구동
                </dt>
                <dt>
                  회생제동 기능을 이용한 운행 중 배터리 충전으로 제동횟수가 많은
                  도심에서 에너지 효율성 극대화
                </dt>
                <dd>
                  * 회생제동 : 브레이크 제동 시 모터가 발전기로 전환되어 역으로
                  배터리를 충전
                </dd>
              </dl>
            </div>
          ...
          <dl>
            <dt>
              <img className="img3" src={infoImg3} alt="img" />
            </dt>
            <dt>
              <img className="img4" src={infoImg4} alt="img" />
            </dt>
          </dl>
          ...
          <dl className="info1-3">
            <dt>친환경적</dt>
            <dd>
              주행시 화석연료를 사용하지 않아 CO<sub>2</sub>나 NOx를 배출하지
              않음
            </dd>
            <dd>엔진 소음이 적고, 진동이 적음</dd>
            <dt>경제적</dt>
            <dd>
              전기모터로만 구동할 경우 운행비용이 가장 저렴하고, 심야 전기를
              이용할 경우 비용을 더 낮출 수 있음
            </dd>
